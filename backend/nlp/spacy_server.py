...
class CommandParser:
    ...
    ACTION_INTENTS = {
        ...
        'reload': ['reload', 'refresh', 'update', 'renew', 'restart', 'reload page', 'refresh page', 'reload this', 'refresh this', 'update page'],
        'help': ['help', 'help me', 'what can you do', 'show help', 'assist', 'guide me', 'how do i'],
        'back': ['back', 'return', 'previous', 'revert', 'go back', 'previous page', 'back page', 'navigate back', 'backwards', 'backward'],
        'forward': ['forward', 'next', 'advance', 'continue', 'proceed', 'go forward', 'next page', 'forward page', 'navigate forward', 'forwards'],
